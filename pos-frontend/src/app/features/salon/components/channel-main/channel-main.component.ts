        ...
        @for (pedido of filteredPedidos(); track pedido.id) {
          ...
          >
            ...
            <div class="pedido-card__row">
              ...
              @if (canal().tipo === 'DELIVERY' || canal().tipo === 'PEDIDOS_YA' || canal().tipo === 'RAPPI') {
            ...
            <div class="pedido-card__bottom">
              ...
              <div class="pedido-card__actions">
                @if (pedido.estado === 'EN_CURSO') {
                  <button class="act-btn act-btn--primary" (click)="$event.stopPropagation()">Marcar listo</button>
                } @else if (pedido.estado === 'LISTO') {
                  <button class="act-btn act-btn--primary" (click)="$event.stopPropagation()">Entregar</button>
                }
                <button class="act-btn" (click)="$event.stopPropagation()">Detalle</button>
              </div>
            </div>
          </div>
        }
